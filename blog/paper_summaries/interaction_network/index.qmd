...
date: "2020-06-26"
pagetitle: "Interaction Networks"
image: "./img/implementation.png"
image-width: 1800px 
categories: [neural network, graph networks]
draft: false
---
...
| ![Schematic of the IN's update procedure for an exemplary IN](./img/IN.png "Schematic of the IN's update procedure") |
| :--         |
...
| ![One step roll out of the IN implementation](./img/implementation.png "One step roll out of the IN implementation") |
| :--         |
